...
These SYNC samples demonstrate the capabilities to read accounts, groups and hosts from an Active Directory
...
$ $SYNC_HOME/bin/lsc -f $SYNC_HOME/sample/ad/etc-ad2opendj etc -a all -t 1

or 

> %SYNC_HOME%\bin\lsc.bat -f %SYNC_HOME%\sample\ad\etc-ad2opendj -a all -t 1

If you don't give any details about the host and URL, SYNC will locate a domain controller through a DNS request
